...
public class userService {
    ...
    public userService(String emails, String passwords)
    {
        ...
        String[][] data = 
        { 
            {"ishaqkelompok37@gmail.com", "12345", "superAdmin"},
            {"gitakelompok37@gmail.com", "12345", "user"} 
        };
        String[][] histories =
        {
            {"ishaqkelompok37@gmail.com","Fisika Dasar","Dasar Komputer dan Pemrograman","25-04-2020"},
            {"gitakelompok37@gmail.com","Dasar Komputer dan Pemrograman","Konsep Jaringan Komputer","25-04-2020"}
        };
        this.data = data;
